...
arbitrage_abi = [
	...
	},
	{
		...
		"outputs": [
			{
				"internalType": "contract DemaxPlatform",
				"name": "",
				"type": "address"
			}
		],
	...
	},
	{
		...
		"outputs": [
			{
				"internalType": "contract BakerySwapRouter",
				"name": "",
				"type": "address"
			}
		],
      ...
      "outputs": [
        {
          ...
          "internalType": "struct GetExchangeRates.Pair[]",
          "name": "",
          "type": "tuple[]"
        }
      ],
      ...
      "inputs": [
        {
          ...
          "internalType": "struct Aave1.Path[]",
          "name": "paths",
          "type": "tuple[]"
        },
        {
      ...
      "inputs": [
        {
          ...
          "internalType": "struct Alpha1.Path[][]",
          "name": "_paths",
          "type": "tuple[][]"
        },
        {
      ...
      "outputs": [
        {
          ...
          "internalType": "struct Alpha1.AmountsOut[]",
          "name": "",
          "type": "tuple[]"
        }
      ],
      ...
      "outputs": [
        {
          ...
          "internalType": "struct Alpha1.Pair[]",
          "name": "",
          "type": "tuple[]"
        }
      ],
      ...
      "inputs": [
        {
          ...
          "internalType": "struct Alpha.Path[][]",
          "name": "_paths",
          "type": "tuple[][]"
        },
        {
      ...
      "outputs": [
        {
          ...
          "internalType": "struct Alpha.Pair[]",
          "name": "",
          "type": "tuple[]"
        }
      ],
      ...
      "inputs": [
        {
          ...
          "internalType": "struct OnChainArb1.Path[]",
          "name": "paths",
          "type": "tuple[]"
        },
        {
